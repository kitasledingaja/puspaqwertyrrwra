            ...
            <div class="card">
              <div class="card-header"> <h5> Lihat Data Merchandise </h5> <i class="fa fa-bell fa-fw"></i> </div>
                ...
                <div class="row">
                  ...
                  <td class="text-center"><a class="btn btn-success waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Edit" href="<?=base_url() ?>index.php/gallery/updateDataGallery/<?=$data->id_gallery; ?>"><i class="icofont icofont-ui-edit"></i></a></td>
