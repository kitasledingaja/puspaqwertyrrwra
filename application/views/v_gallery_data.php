...
<html lang="en">
<head>
    <title>Lihat Gallery | Float Indonesia</title>
    ...
    <div class="content-wrapper">
       ...
       <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    <h4>Halaman Melihat Data Gallery</h4>
        ...
        <div class="row">
         ...
         <form action="alldata_gallery_admin" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
              <div class="card-header"> <h5> Lihat Data Gallery </h5> <i class="fa fa-bell fa-fw"></i> </div>
                <div class="card-block">
                <div class="row">
                  ...
                  <thead> 
                      <tr>
                        ...
                        <th class="text-center pro-pic">Photo</th>
                  ...
                  <td class="text-center"><img src="<?php echo base_url('assets/images/').$data->photo;?>" width="300px"/></td>
                  <td class="text-center"><?= $data->caption; ?></td>
                  <td class="text-center"><?= $data->tanggal_upload; ?></td>
                  <td class="text-center"><a class="btn btn-primary waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Lihat" href="<?= base_url('index.php/gallery_all/viewgallery'); ?>"><i class="icofont icofont-eye-alt"></i></a></td>

                  <td class="text-center"><a class="btn btn-success waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Edit" href="<?=base_url() ?>index.php/gallery/updateGallery/<?=$data->id_gallery; ?>"><i class="icofont icofont-ui-edit"></i></a></td>

                  <td class="text-center"><a class="btn btn-danger waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Hapus" href="<?=base_url() ?>index.php/gallery/deleteDataGallery/<?=$data->id_gallery; ?>"><i class="icofont icofont-ui-delete"></i></a></td>
