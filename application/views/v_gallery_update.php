...
<html lang="en">
<head>
    <title>Ubah Gallery | Float Indonesia</title>
    ...
    <div class="content-wrapper">
       ...
       <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    <h4>Halaman Mengubah Gallery</h4>
        ...
        <div class="row">
          ...
          <form action="<?=base_url() ?>index.php/gallery/updateGalleryDb" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
              <div class="card-header"> <h5> Ubah Gallery </h5> <i class="fa fa-bell fa-fw"></i> </div>
                <div class="card-body">
                <div class="row">
                  <div class="form-group row">
                        <div class="col-md-10 container dim-container" style="padding-left: 40px;">
                  <?php foreach($gallery as $detail){ ?>
                    <div class="col-md-5">
                          <div class="form-group">

                          <b> Caption : </b>
                              <textarea class="form-control" name="caption" value=<?=form_textarea('caption', "$detail->caption", 'form-control')?></textarea>
                            </div>

                    <div class="col-md-15">
                              <label for="file" class="custom-file">
                                  <input type="file" name="photo" id="file" class="custom-file-input" value=<?=form_upload('photo', "$detail->photo", 'form-control')?>
                                         <span class="custom-file-control"></span>
                              </label>
                      <input type="hidden" name="id_gallery" value="<?php echo $detail->id_gallery; ?>">
                      </div>
                                    </div>
                                  </div>
              </div>
