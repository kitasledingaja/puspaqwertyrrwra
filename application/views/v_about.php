...
<html>
<head>
<title>About | Float Indonesia</title>
	 ...
	 <div class="container">
		 ...
		 <div class="about-info-grids">
			 <div class="col-md-5 abt-pic">
				 <img src="<?= base_url();?>assets/images/abt.jpg" class="img-responsive" alt=""/>
			 </div>
			 <div class="col-md-7 abt-info-pic">
				 <h3>Float.Id merupakan sebuah perusahaan yang bergerak sebagai Game Developer di Kota Batam</h3>
				 <p>Float.Id hadir dengan mimpi besar, menghasilkan game karya anak bangsa yang dapat selalu menempati posisi teratas di tengah ramainya game game asing yang masuk ke indonesia. Float.ID Layaknya sebuah minuman float, float id juga berkomitmen untuk menghasilkan game game yang </p>
				 <ul>
					 <li>Enak dimainkan</li>
					 <li>Segar</li>
					 <li>Dan dimainkan oleh banyak orang</li>
				 </ul>
				 <p>Float ID memiliki positioning untuk memperkenalkan Khazanah Indonesia melalui game-game yang dihasilkannya dengan segmen pengguna smartphone berbasis android.</p>
				 <p>Tak hanya merilis game di marketplace, Float ID juga menyediakan layanan game customize sesuai selera klien. Float ID tidak hanya merancang game dengan basis 2D namun juga mampu merancang game berbasis 3D.</p>
			 </div>
			 <div class="clearfix"></div>
		 </div>
		 <div class="testimonals">
		   ...
		   <div class="team">
			  ...
			  <div class="grid_4">
				<div class="team-grid">
						   <img src="<?= base_url();?>assets/images/a1.jpg" alt="">
			  ...
			  <div class="grid_4">
				 <div class="team-grid">
						   <img src="<?= base_url();?>assets/images/a2.jpg" alt="">
						   <h4>Phasellus scipitilifen lus.</h4>
						  <p>Kuspendisse laoreet augue iderti wer  interdum merti oremolo lectusto odio, sedorolu fringilla estero libero. </p>
					  </div>
			  </div>
			  <div class="grid_4 span66">
				<div class="team-grid">
						   <img src="<?= base_url();?>assets/images/a3.jpg" alt="">
						   <h4>Phasellus scipitilifen lus.</h4>
						  <p>Kuspendisse laoreet augue iderti wer  interdum merti oremolo lectusto odio, sedorolu fringilla estero libero. </p>
					  </div>
			  </div>      
