...
<header class="main-header-top hidden-print">
    <a href="index.html" class="logo"><img class="img-fluid able-logo" src="<?php echo base_url(); ?>assets/images/logo-float.png" alt="Theme-logo"></a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu settings-menu">
                                ...
                                <li><a href="<?= base_url();?>"><i class="icon-logout"></i> Logout</a></li>
        ...
        <aside class="main-sidebar hidden-print " >
            <section class="sidebar" id="sidebar-scroll">
                ...
                <ul class="nav sidebar-menu extra-profile-list">
                    ...
                    <li>
                        <a class="waves-effect waves-dark" href="<?= base_url();?>index.php/login/logout">
                    ...
                    <div class="main-friend-list">
                        <div class="media friendlist-box" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip" data-placement="left" title="Josephin Doe">
                            ...
                            <div class="media-body">
                                <div class="friend-header">Puspa Kartika</div>
                                <span>20min ago</span>
                            </div>
                        </div>
    ...
    <div class="col-xl-4 col-lg-12">
        <div class="card">
            <div class="user-block-2">
                <img class="img-fluid" src="<?= base_url();?>assets/images/avatar-6.png" alt="user-header">
                <h5>Puspa Kartika</h5>
                <h6>Web Developer</h6>
            </div>
            <div class="card-block">
