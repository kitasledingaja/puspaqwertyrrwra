...
<html lang="en">
<head>
    <title>Buat Gallery | Float Indonesia</title>
    ...
    <div class="content-wrapper">
       ...
       <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    <h4>Halaman Memasukkan Gallery</h4>
        ...
        <div class="row">
          ...
          <form action="datagallery" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
              <div class="card-header"> <h5> Masukkan Gallery </h5> <i class="fa fa-bell fa-fw"></i> </div>
                <div class="card-body">
                <div class="row">
            ...
            <center><button type="upload" class="btn btn-primary btn-lg">Upload</button></center>
          </div>
          </form>
                            <p class="m-b-20">
                            </p>
