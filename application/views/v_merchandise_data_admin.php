...
<html lang="en">
<head>
    <title>Lihat Merchandise | Float Indonesia</title>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span> Artikel </span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                            ...
                            <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i>Buat Merchandise</a></li>
                    ...
                    <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-eye"></i><span> Lihat Data</span><i class="icon-arrow-down"></i></a>
                        <ul class="treeview-menu">
                            <li><a class="waves-effect waves-dark" href="<?php echo base_url()?>index.php/artikel/alldata"><i class="icon-arrow-right"></i>Lihat Data Artikel</a></li>
                             <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i>Lihat Data Merchandise</a></li>
    ...
    <div class="content-wrapper">
       ...
       <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 p-0">
                <div class="main-header">
                    <h4>Halaman Melihat Data Merchandise</h4>
        ...
        <div class="row">
         ...
         <form action="dataall" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
              <div class="card-header"> <h5> Lihat Data Merchandise </h5> <i class="fa fa-bell fa-fw"></i> </div>
                <div class="card-block">
                <div class="row">
                  ...
                  <thead> 
                      <tr>
                        ...
                        <th class="text-center pro-pic">Harga</th>
                  ...
                  <td class="text-center">Rp. <?php echo number_format($data->price,0,",",".");?></td>
                  <td class="text-center"><?php echo $data->desc;?></td>
                  <td class="text-center"><img src="<?php echo base_url() . 'assets/images/'.$data->picture; ?>" width="300px"/></td>
                  <td class="text-center"><a class="btn btn-primary waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Lihat" href="<?= base_url('index.php/marchandise/index'); ?>"><i class="icofont icofont-eye-alt"></i></a></td>

                  <td class="text-center"><a class="btn btn-success waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Edit" href="<?=base_url() ?>index.php/marchandise/updateDataMerch/<?=$data->id_merchandise; ?>"><i class="icofont icofont-ui-edit"></i></a></td>

                  <td class="text-center"><a class="btn btn-danger waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Hapus" href="<?=base_url() ?>index.php/marchandise/deleteDataMerch/<?=$data->id_merchandise; ?>"><i class="icofont icofont-ui-delete"></i></a></td>
